				...
				<tr>
					...
					for ( $col = 0; $col < $cols; $col++ ):
						...
						if ( sp_array_value( $cell, 'type', null ) === 'event' ):
							...
							if ( $event ) {
								$event_name = '<span class="sp-result-wrapper"><span class="sp-result">' . implode( '</span>-<span class="sp-result">', apply_filters( 'sportspress_main_results_or_time', sp_get_main_results_or_time( $event ), $event ) ) . '</span></span>';
