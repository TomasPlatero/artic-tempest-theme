...
<form method="post">
	<div class="sp-template sp-template-user-results sp-template-event-user-results card card--has-table">
		<header class="card__header">
			<h4 class="sp-table-caption"><?php empty( $user_results ) ? esc_html_e( 'Submit Your Results', 'sportspress' ) : esc_html_e( 'Update Your Results', 'sportspress' ); ?></h4>
			<input name="submit" type="submit" id="submit" class="btn btn-primary btn-xs card-header__button" value="<?php esc_html_e( 'Submit', 'sportspress' ); ?>">
								...
								<tr>
									...
									<?php foreach ( $labels as $key => $label ): ?>
										...
										<td class="data-<?php echo $key; ?>">
											<input class="form-control" type="text" name="sp_results[<?php echo $team; ?>][<?php echo $key; ?>]" placeholder="<?php echo $placeholder; ?>">
										</td>
									<?php endforeach; ?>
								</tr>
							<?php } ?>
