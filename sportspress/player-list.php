	...
	if ( $title ) {
		...
		$output .= '<header class="card__header">';
			...
			if ( $show_all_players_link ):
				$output .= '<a href="' . get_permalink( $id ) . '" class="' . esc_attr( implode( ' ', $card_header_btn_classes ) ) . '">' . esc_html__( 'View all players', 'sportspress' ) . '</a>';
			endif;
...
foreach ( $groups as $group ) :
	...
	if ( ! is_array( $labels ) || array_key_exists( 'number', $labels ) ) :
		if ( in_array( $orderby, array( 'number', 'name' ) ) ) :
			...
			$thead .= '<th class="data-rank">' . esc_html__( 'Rank', 'sportspress' ) . '</th>';
		endif;
	endif;
